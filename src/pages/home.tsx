...
export default function Home() {
  ...
  const soldCars = (cars || []).filter(c => c.status === "sold").slice(0, 6);
  ...
  return (
    <Layout>
      ...
      {/* Featured New Assets — always max 6 */}
      <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="flex justify-between items-end mb-12">
          <div>
            ...
            <div className="w-20 h-1 bg-primary box-glow" />
          </div>
          <Link
            href="/garage"
            className="hidden sm:flex items-center gap-2 text-primary font-semibold hover:text-white transition-colors uppercase tracking-wider text-sm"
          >
        ...
        <div className="mt-10 sm:hidden text-center">
          <Link
            href="/garage"
            className="inline-flex items-center gap-2 text-primary font-semibold hover:text-white transition-colors uppercase tracking-wider text-sm"
          >
